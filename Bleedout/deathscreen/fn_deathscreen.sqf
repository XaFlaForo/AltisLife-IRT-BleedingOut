/*
    ...
    Author: Ra's Al Ghul (76561198094478387), Further Edited XaLaForo (76561198082881619) 
...
diag_LOG "ENTERED";
SOMEVAR = false;
IRT_MedicRequested = false;
IRT_DeathscreenObject = _unit;
...
(findDisplay 7300) displaySetEventHandler ["KeyDown","if ((_this select 1) isEqualTo 207) then {false}"]; //--- Block The End Key
    ...
    while{true}do{
        ...
        {
            _distance = IRT_DeathscreenObject distance _x;
        ...
        if(isNull _NearestMedic)then{
            ...
            _MedicDistance = IRT_DeathscreenObject distance _NearestMedic;
